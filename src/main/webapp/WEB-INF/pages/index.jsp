...
<body role="document">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Ryan Leigh's Bespoke Suits for Dogs!!</a>
      </div>
  ...
  <div class="container theme-showcase" role="main">
    ...
    <% } %>
    <div class="jumbotron">
      <h1>Trent's Bespoke Suits for Dogs</h1>
      ...
      <div class="col-sm-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <img src="https://unsplash.it/287/360/?random" style="width:287px;height:300px;">
          </div>
        </div>
      </div>
    </div>
